...
/**
 * @param {{ email: string, password: string, ipHash: string, totp?: string, req?: import("http").IncomingMessage }} input
 */
export async function verifyLoginCredentials({ email, password, ipHash, totp, req }) {
