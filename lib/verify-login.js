...
/**
 * Verifica credenciales con bcrypt, rate limiting y bloqueo de cuenta.
 * @param {{ email: string, password: string, ipHash: string }} input
 */
export async function verifyLoginCredentials({ email, password, ipHash }) {
